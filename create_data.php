...
<head>
    ...
    <title>Insert new Data | ChatMed</title>
...
<main>
    <div class="bg-slate-50 h-screen px-4 py-12 lg:p-12 space-y-10">
        <h1 class="text-gray-900 font-semibold text-2xl mb-10">Insert New Data</h1>

        <div>
            <form action="functions/store_data.php" method="post">
                <div>
                    <label
                            for="data_question"
